...
# <img src="assets/logo.png" alt="Komandus Logo" width="32" style="vertical-align:middle;"/> Командус

## 👨‍💻 KYSS

## 👥 Команда:
- [Маслов Даниил](https://t.me/Danyayokich) ([GitHub](https://github.com/danyayok)) - Капитан команды, Backend Developer
- [Васильев Артём](https://t.me/avslyv) ([GitHub](https://github.com/avslyv)) - Tech Lead / Technical Product Manager
- [Ржевский Иван](https://t.me/jeanrezerford) ([GitHub](https://github.com/BigDuckteams)) - Frontend Developer
- [Подколзин Алексей](https://t.me/fillllka) ([GitHub](https://github.com/Fosh1er)) - ML / ASR Engineer
