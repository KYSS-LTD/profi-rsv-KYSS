...
export function SaasTasksPage() {
  ...
  return <><PageHeader eyebrow="Канбан Командуса" title="Задачи" description="Собственный канбан: Командус остаётся источником истины, а YouGile — внешней синхронизируемой доской." />
    ...
    {selected && createPortal(<div className="fixed inset-0 z-50 bg-stone-950/30" onClick={() => setSelected(null)}><aside className="ml-auto h-full w-full max-w-xl overflow-y-auto bg-white p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
