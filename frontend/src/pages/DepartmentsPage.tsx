...
export function DepartmentsPage() {
  ...
  return <><PageHeader eyebrow="Org model" title="Отделы" description="Организация → отделы → команды → сотрудники → Telegram-чаты. Эта структура используется в AI-пайплайне и правах доступа." />
