...
const lifecycle = ['To Do → TO_DO', 'In Progress → IN_PROGRESS', 'Review → REVIEW', 'Done → DONE'];
...
export function BoardsPage() {
  ...
  return <><PageHeader eyebrow="Интеграции" title="Интеграции" description="Telegram слушает рабочие чаты, OpenAI извлекает задачи, YouGile получает подтвержденные карточки через provider abstraction." />
