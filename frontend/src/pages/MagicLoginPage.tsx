  ...
  return (
    <main className="grid min-h-screen place-items-center bg-stone-950 p-4 text-white">
      <Card className="max-w-md bg-white p-6 text-stone-950">
        <h1 className="text-2xl font-semibold">Вход по Telegram-ссылке</h1>
        ...
        {mutation.error && <p className="mt-4 rounded-xl bg-red-50 p-3 text-sm text-red-700">Ссылка недействительна, истекла или уже использована. Вернитесь в Telegram и выполните /login.</p>}
