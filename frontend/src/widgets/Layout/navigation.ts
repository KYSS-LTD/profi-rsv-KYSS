...
export const navigation: NavigationItem[] = [
  ...
  { to: '/tasks', label: 'Мои задачи', description: 'Личный канбан', icon: KanbanSquare, roles: allRoles },
  ...
  { to: '/boards', label: 'Интеграции', description: 'Telegram / YouGile / LLM', icon: PlugZap, roles: [...adminRoles, ...ownerRoles] },
  { to: '/notifications', label: 'Уведомления', description: 'События и риски', icon: Bell, roles: [...managerRoles, ...adminRoles, ...ownerRoles] },
  { to: '/setup', label: 'Настройки', description: 'Мастер настройки', icon: Settings, roles: [...adminRoles, ...ownerRoles] },
];
